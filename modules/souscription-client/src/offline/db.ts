// Stockage local (IndexedDB via Dexie) de la PWA CLIENTE souscription : souscriptions + pièces
// (blobs entiers). Base distincte de l'app agent. Consultable hors-ligne.
...
export const db = new SouscriptionClientDb();
