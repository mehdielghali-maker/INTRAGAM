 ...
 * par tous les écrans) et la liste (plate) des agences autorisées (périmètre SSO).
 *
 * @param agenceActive        agence active ; {@code null} en mode consolidé
 * @param consolideDisponible vue « Toutes mes agences (consolidé) » proposable (≥ 2 agences)
